-- Production foundation. Back up first; apply once or safely reapply in SQL Editor.
-- This upgrade never guesses that historic cash receipts were actually collected.
begin;
